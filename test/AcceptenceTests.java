...
public class AcceptenceTests {
    ...
    public void testAssginGames() throws SQLException {
        ...
        assertEquals("Must get 'Team is already playing at this date'", "Team is already playing at this date", ua.assginGames("tair", "eyal", "shachar", "rony", "valencia", "barcelona", "bernabeu", "LA LEAGUE", Date.valueOf("2021-12-20")));
